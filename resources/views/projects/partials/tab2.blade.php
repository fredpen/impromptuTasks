        ...
        <div class="card widget-flat col-sm-12">
            <div class="card-body pt-3 pb-0 px-0" style="position: relative;">
                <div class="col-sm-12">
                    ...
                    <textarea onchange="updateProject(this, 'description')" data-toggle="maxlength" class="mb-3 form-control" data-threshold="5000" maxlength="5000" rows="5" placeholder="This textarea has a limit of 5000 chars.">{{$project->description}}</textarea>
                </div>
            </div>
        </div>
    </div>
